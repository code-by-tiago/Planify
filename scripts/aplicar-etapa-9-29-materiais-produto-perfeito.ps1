...
Write-Step "Planify | Etapa 9.29.0 - Materiais Produto Perfeito"
...
$relativeFiles = @(
  ...
  "src\types\ai.ts",
  "docs\9-29-0-materiais-produto-perfeito.md",
  "scripts\aplicar-etapa-9-29-materiais-produto-perfeito.ps1"
)
...
$backupRoot = Join-Path $ProjectRoot "backups\9-29-0-materiais-produto-perfeito-$timestamp"
...
try {
  ...
  Write-Ok "BUILD OK - Etapa 9.29 aplicada com sucesso."

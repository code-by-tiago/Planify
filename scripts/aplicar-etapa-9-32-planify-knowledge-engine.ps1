...
Write-Step "Planify | Etapa 9.32.0 - Knowledge Engine Pedagogico"
...
$relativeFiles = @(
  ...
  "src\lib\materiais\material-pedagogical-reference-kernel.ts",
  "src\lib\materiais\material-knowledge-engine.ts",
  "src\lib\materiais\material-quality-auditor.ts",
  "src\types\ai.ts",
  "docs\9-32-0-planify-knowledge-engine.md",
  "scripts\aplicar-etapa-9-32-planify-knowledge-engine.ps1"
)
...
$backupRoot = Join-Path $ProjectRoot "backups\9-32-0-planify-knowledge-engine-$timestamp"
...
try {
  ...
  Write-Ok "BUILD OK - Etapa 9.32 aplicada com sucesso."
  Write-Host "Agora faca commit/push com o bloco enviado na conversa." -ForegroundColor Green
}
finally {
  Pop-Location
}

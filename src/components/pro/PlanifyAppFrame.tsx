  ...
  return (
    <main className="planify-hud planify-ui3 planify-hud-app pl-shell-root pl-hud-shell pl-app-bg flex h-[100dvh] w-full max-w-[100vw] overflow-hidden text-slate-950">
      ...
      <section className="flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-white">
        <header className="flex shrink-0 flex-wrap items-center justify-between gap-2 border-b border-cyan-400/15 bg-white/95 px-4 py-2.5 pt-[max(0.5rem,env(safe-area-inset-top))] sm:gap-3 sm:px-5">
          <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3">
            ...
            {!compact ? (
              <div className="min-w-0">
                <h1 className="line-clamp-2 text-sm font-semibold tracking-tight leading-snug text-slate-900 sm:text-base">
                  {pageMeta.title}
                </h1>

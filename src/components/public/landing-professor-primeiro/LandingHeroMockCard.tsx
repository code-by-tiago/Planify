...
export function LandingHeroMockCard() {
  return (
    <div className="relative mx-auto w-full max-w-md lg:mx-0 lg:max-w-none">
      <div
        aria-hidden
        className="absolute -right-6 -top-6 h-32 w-32 rounded-full bg-emerald-400/20 blur-3xl"
      />
      <div
        aria-hidden
      ...
      <div className="relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-5 shadow-2xl shadow-slate-900/10 sm:p-6">
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          <span className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700">
            <PlanifyIcon name="download" className="h-3.5 w-3.5 text-emerald-600" />
            Gerar DOCX
          </span>
        ...
        <div className="mt-4 flex items-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2.5">
          <PlanifyIcon name="checkCircle" className="h-4 w-4 shrink-0 text-emerald-600" />
          <p className="text-xs font-bold text-emerald-800">Pronto para editar!</p>
        </div>
      </div>
    </div>
  );

        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3">
          {HOW_IT_WORKS.map((item) => (
            <article key={item.step} className="relative text-center md:text-left">
              <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-600 font-[family-name:var(--font-display)] text-xl font-extrabold text-white shadow-lg shadow-emerald-600/25">
                {item.step}
              </span>

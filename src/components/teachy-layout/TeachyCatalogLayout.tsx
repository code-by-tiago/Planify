  ...
  return (
    <div className="pf-scope planify-hud planify-public flex min-h-screen flex-col bg-[var(--pf-canvas)]">
      ...
      <main className="flex-1">
        <section className="border-b bg-white px-5 py-12 sm:px-8 sm:py-16">
          <div className="mx-auto max-w-7xl">
            <p className="pf-eyebrow">Catálogo Planify</p>
            <h1 className="pf-headline mt-3 max-w-3xl text-3xl font-extrabold uppercase tracking-tight sm:text-4xl">
              Crie conteúdo pedagógico com IA
            </h1>
            <p className="mt-4 max-w-2xl text-base font-medium leading-7 text-slate-600">
              {planifyTools.length} ferramentas para professores — planejamentos BNCC, materiais,
              avaliações e correção. Entre e comece grátis.
            </p>

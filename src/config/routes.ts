...
export const appRoutes: AppRoute[] = [
  ...
  },
  {
    href: "/materiais",
    label: "Materiais",
    description: "Gerador visual de materiais didáticos.",
    group: "teacher",
    status: "visual",
  },
  {
    href: "/editor",
    label: "Editor",
    description: "Editor visual para revisão de documentos pedagógicos.",
    group: "teacher",
    status: "visual",
  },
  {
    href: "/historico",
    label: "Histórico",
    description: "Histórico visual de documentos, materiais e itens salvos.",
    group: "teacher",
    status: "visual",
  },
  {
  ...
  },
  {
    ...
    description: "Publicação visual de material para o Marketplace.",
    group: "premium",
    status: "visual",
  },
  {

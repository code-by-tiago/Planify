...
export const dashboardCards: DashboardCard[] = [
  ...
  },
  {
    title: "Marketplace",
    href: "/marketplace",
    description: "Troque materiais pedagógicos com outros professores.",
    badge: "Comunidade",
    metric: "Visual",
    icon: "marketplace",
    accent: "violet",
...
const commonFeatures: ProductPageFeature[] = [
  ...
  },
  {
    ...
    description: "Base pronta para Supabase, Stripe, IA, Storage e DOCX.",
  },
];
...
export const pageContent: Record<string, ProductPageContent> = {
  planejamentos: makeContent({
    ...
    highlights: ["BNCC oficial", "Seleção manual", "Prévia estruturada", "DOCX futuro"],
  ...
  materiais: makeContent({
    ...
    highlights: ["7 tipos", "Prévia visual", "Editor preparado", "IA futuro"],
    features: commonFeatures,
    workflow: [
  ...
  editor: makeContent({
    ...
    highlights: ["Edição visual", "Prévia", "Salvar visualmente", "Exportação futura"],
    features: commonFeatures,
    workflow: [
  ...
  historico: makeContent({
    ...
    panelDescription: "Histórico visual preparado para dados reais.",
    panelItems: ["Planejamentos", "Materiais", "Editor", "Biblioteca", "Marketplace"],
    highlights: ["Busca", "Filtros", "Abrir no editor", "Supabase futuro"],
    features: commonFeatures,
    workflow: [
  ...
  biblioteca: makeContent({
    ...
    description: "Biblioteca premium separada do Marketplace.",
    href: "/biblioteca",
    primaryAction: "Abrir biblioteca",
    secondaryAction: "Ir ao Marketplace",
    badge: "Curadoria",
    ...
    highlights: ["Premium", "Admin", "Filtros", "Download futuro"],
    features: commonFeatures,
    workflow: [
      { title: "Filtrar", description: "Encontre materiais." },
      { title: "Visualizar", description: "Confira detalhes." },
      { title: "Baixar", description: "Download será conectado ao Storage." },
    ],
  }),
  marketplace: makeContent({
    eyebrow: "Marketplace",
    title: "Troca entre professores.",
    description: "Professores poderão publicar, salvar e baixar materiais pedagógicos.",
    href: "/marketplace",
    primaryAction: "Publicar material",
    secondaryAction: "Ver biblioteca",
    badge: "Comunidade",
    panelTitle: "Marketplace docente",
    panelDescription: "Área de troca de materiais com anexos e moderação futura.",
    panelItems: ["Publicação", "Anexos", "Busca", "Downloads", "Moderação"],
    highlights: ["Upload preparado", "Busca", "Salvar", "Moderação futura"],
    features: commonFeatures,
    workflow: [
      ...
      { title: "Moderar", description: "Admin poderá controlar publicações." },
    ],
  }),
  admin: makeContent({
    eyebrow: "Admin",
    ...
    panelItems: ["Usuários", "Assinaturas", "Biblioteca", "Marketplace", "Sistema"],

...
export const pageContent: Record<string, ProductPageContent> = {
  ...
  marketplace: makeContent({
    ...
    description: "Professores publicam, salvam e baixam materiais pedagógicos.",
    href: "/marketplace",
    primaryAction: "Publicar material",
    secondaryAction: "Ver biblioteca",
    badge: "Comunidade",
    panelTitle: "Marketplace docente",
    panelDescription: "Área de troca de materiais com anexos e curadoria da comunidade.",

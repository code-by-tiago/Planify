...
/** Fluxo principal da landing pública (professores) */
export const landingHomeFeatures: {
  title: string;
  description: string;
  cta: string;
  href: string;
...
/** Destaque de inclusão na landing */
export const landingInclusionFeature = {
...
export const landingTrustSchools = [
  "Ensino Fundamental",
  "Ensino Médio",
  "Educação Infantil",
  "Matemática",
...
export const landingPartnerLabels = [
  "BNCC",
  "Google Classroom",
  "Google Slides",
  "Modelo oficial",
